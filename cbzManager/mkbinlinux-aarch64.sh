...
cp ~/Dev/cbzManager/cbzManager/Library/cbzlibrarylinux-aarch64 ~/Dev/cbzManager/precompiled\ binairies/Linux/aarch64/Files/cbzLibrary

sudo cp ~/Dev/cbzManager/cbzManager/cbzManager /usr/local/bin
sudo cp ~/Dev/cbzManager/precompiled\ binairies/Linux/aarch64/Files/cbzLibrary /usr/local/bin
