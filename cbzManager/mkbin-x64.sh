...
then
	...
	rm ~/Dev/cbzManager/precompiled\ binairies/Mac\ OsX/x64/cbzManagerOsx.app/Contents/MacOS/cbzManagerOsx 
	cp ~/Dev/cbzManager/cbzManager/cbzManagerOsx ~/Dev/cbzManager/precompiled\ binairies/Mac\ OsX/x64/cbzManagerOsx.app/Contents/MacOS/

	rm ~/Dev/cbzManager/precompiled\ binairies/Mac\ OsX/x64/cbzLibraryOsx.app/Contents/MacOS/cbzLibraryOsx 
	cp ~/Dev/cbzManager/cbzManager/Library/cbzLibraryOsx ~/Dev/cbzManager/precompiled\ binairies/Mac\ OsX/x64/cbzLibraryOsx.app/Contents/MacOS/
	...
	zip -r cbzManagerOsx-x64.zip cp -r cbzManagerOsx.app cbzLibraryOsx.app
