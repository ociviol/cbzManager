...
uses
  Classes, SysUtils, Messages, LCLType, LCLIntf, Forms, Controls, ExtCtrls,
  Graphics, Menus;
...
type
  ...
  protected
    ...
    procedure MouseDown(Button: TMouseButton; Shift: TShiftState; {%H-}X, {%H-}Y: Integer); override;
  public
    constructor Create(TargetObj: TTargetObj;
      BtnPos: TBtnPos); reintroduce;
  end;
  ...
  private
    ...
    procedure DoMouseDown(Sender: TObject; {%H-}Button: TMouseButton; {%H-}Shift: TShiftState);
    ...
    WM_SETCURSOR:
      ...
      begin
        ...
        begin
          ...
          else SetCursor(screen.Cursors[crSize]);
