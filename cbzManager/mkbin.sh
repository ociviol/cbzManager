...
~/fpcupdeluxe/fpc/bin/x86_64-darwin/fpc.sh -B -MObjFPC -Scghi -CX -O3 -XX -k-framework -kCocoa -l -vewnhibq -Fi./lib/x86_64-darwin -Fu../Utils -Fu../Utils/zipfile -Fu~/fpcupdeluxe/lazarus/lcl/units/x86_64-darwin/cocoa -Fu~/fpcupdeluxe/lazarus/lcl/units/x86_64-darwin -Fu~/fpcupdeluxe/lazarus/components/lazutils/lib/x86_64-darwin -Fu~/fpcupdeluxe/lazarus/packager/units/x86_64-darwin -Fu./ -FU./lib/x86_64-darwin/ -FE./ -o./cbzManagerOsx -dLCL -dLCLcocoa -dUseCThreads cbzManagerOsx.lpr
